...
public class Paths_Library_Blue_3Cubes_Backup {


    private static OurPoint[] Left1Points = {
            new OurPoint(-1.566, -0.8325, 220),
            new OurPoint(-0.76, -1.39, 220),
            new OurPoint(-0.53, -1.63, 180)};
    ...
    private static OurPoint[] LeftFoundationPoints = {
            ...
            new OurPoint(-1, 0.8, 90),
            new OurPoint(-1.35, 1.25, 90),
            new OurPoint(-0.8, 1.25, 90)};
    private static double toleranceLeftFoundation = 95;
    private static double KcLeftFoundation = 1.5;
    private static double MaxVelocityLeftFoundation = 1.5;
    private static double turnSpeedLeftFoundation = 0.8;
    ...
    private static OurPoint[] FoundationBackPoints = {
            new OurPoint(-0.75, 1.25, 90),
            new OurPoint(-1.25, 1.25, 90)};
    ...
    private static double turnSpeedFoundationBack = 0;
    ...
    private static OurPoint[] Left2Points = {
            new OurPoint(-1.5666, 1.25, 175),
            new OurPoint(-1.05, 0.6, 175),
            new OurPoint(-1, 0, 175),
            new OurPoint(-1.05, -0.3, 220),
            new OurPoint(-1.05, -0.6, 220),
            new OurPoint(-0.9, -0.7, 220),
            new OurPoint(-0.6, -1.1, 220)};
    ...
    private static OurPoint[] LeftFoundation2Points = {
            new OurPoint(-0.51, -1.15, 220),
            new OurPoint(-1, -0.7, 180),
            new OurPoint(-1.05, 0.5, 180),
            new OurPoint(-1.05, 1.13, 180)};
    ...
    private static OurPoint[] Left3Points = {
            new OurPoint(-1.3, 1.05, 187),
            new OurPoint(-1.1, 0.6, 187),
            new OurPoint(-1, -0.2, 235),
            new OurPoint(-0.87, -0.55, 235),
            new OurPoint(-0.35, -0.9, 235)};
    ...
    private static OurPoint[] Center1Points = {
            new OurPoint(-1.566, -0.8325, 220),
            new OurPoint(-0.79, -1.22, 220),
            new OurPoint(-0.53, -1.46, 180)};
    private static double toleranceCenter1 = 75;
    private static double KcCenter1 = 1.5;
    ...
    private static OurPoint[] CenterFoundationPoints = {
            ...
            new OurPoint(-1.35, 1.25, 90),
            new OurPoint(-0.8, 1.25, 90)};
    private static double toleranceCenterFoundation = 95;
    private static double KcCenterFoundation = 1.5;
    private static double MaxVelocityCenterFoundation = 1.5;
    private static double turnSpeedCenterFoundation = 0.8;
    ...
    private static OurPoint[] Center2Points = {
            ...
            new OurPoint(-1.05, 0.6, 175),
            new OurPoint(-1, 0, 175),
            new OurPoint(-1.1, -0.16, 205),
            new OurPoint(-1, -0.55, 205),
            new OurPoint(-0.8, -0.59, 205),
            new OurPoint(-0.5, -1.1, 205)};
    private static double toleranceCenter2 = 120;
    private static double KcCenter2 = 10;
    private static double MaxVelocityCenter2 = 1;
    private static double turnSpeedCenter2 = 1;
    ...
    private static OurPoint[] CenterFoundation2Points = {
            new OurPoint(-0.51, -1.05, 205),
            new OurPoint(-1, -0.5, 180),
            new OurPoint(-1.05, 0.5, 180),
            new OurPoint(-1.05, 0.8, 180),
    ...
    private static double turnSpeedCenterFoundation2 = 1;
    ...
    private static OurPoint[] Center3Points = {
            new OurPoint(-1.05, 1.07, 180),
            new OurPoint(-1, 0.6, 180),
            new OurPoint(-1, -0.25, 220),
            new OurPoint(-0.92, -0.6, 220),
            new OurPoint(-0.35, -0.9, 220)};
    private static double toleranceCenter3 = 95;
    private static double KcCenter3 = 2.5;
    private static double MaxVelocityCenter3 = 1.5;
    private static double turnSpeedCenter3 = 0.5;
    private static boolean frontCenter3 = true;
    private static Path Center3 = new Path(Center3Points, toleranceCenter3, KcCenter3, MaxVelocityCenter3, turnSpeedCenter3, frontCenter3);

    private static OurPoint[] CenterFoundation3Points = {
            new OurPoint(-0.35, -0.9, 220),
            new OurPoint(-1.05, -0.75, 180),
            new OurPoint(-1, 0.3, 180),
    ...
    private static double turnSpeedCenterFoundation3 = 0.6;
    private static boolean frontCenterFoundation3 = false;
    private static Path CenterFoundation3 = new Path(CenterFoundation3Points, toleranceCenterFoundation3, KcCenterFoundation3, MaxVelocityCenterFoundation3, turnSpeedCenterFoundation3, frontCenterFoundation3);


    //    TODO Right Points
    private static OurPoint[] Right1Points = {
            new OurPoint(-1.566, -0.8325, 215),
            new OurPoint(-0.79, -0.99, 215),
            new OurPoint(-0.55, -1.25, 180)};
    ...
    private static OurPoint[] RightFoundationPoints = {
            new OurPoint(-0.53, -1.25, 180),
            new OurPoint(-0.92, -0.9, 180),
            new OurPoint(-1, 0.8, 90),
            new OurPoint(-1.35, 1.25, 90),
            new OurPoint(-0.8, 1.25, 90)};
    private static double toleranceRightFoundation = 95;
    private static double KcRightFoundation = 1.5;
    private static double MaxVelocityRightFoundation = 1.5;
    private static double turnSpeedRightFoundation = 0.8;
    ...
    private static OurPoint[] Right2Points = {
            new OurPoint(-1.5666, 1.25, 175),
            new OurPoint(-1.05, 0.6, 175),
            new OurPoint(-1, 0, 223),
            new OurPoint(-0.9, -0.55 ,223),
            new OurPoint(-0.5, -0.75, 223)};
    ...
    private static OurPoint[] RightFoundation2Points = {
            new OurPoint(-0.5, -0.85, 180),
            new OurPoint(-1.05, -0.6, 180),
            new OurPoint(-1.05, 0.5, 180),
            new OurPoint(-1.1, 1.07, 180)};
    ...
    private static double turnSpeedRightFoundation2 = 1;
    ...
    private static OurPoint[] Right3Points = {
            new OurPoint(-1.1, 1.07, 180),
            new OurPoint(-1.05, 0.6, 180),
            new OurPoint(-1.07, -0.3, 205),
            new OurPoint(-0.92, -0.6, 205),
            new OurPoint(-0.45, -1, 205)};
    private static double toleranceRight3 = 95;
    private static double KcRight3 = 2.5;
    private static double MaxVelocityRight3 = 1.5;
    private static double turnSpeedRight3 = 0.5;
    private static boolean frontRight3 = true;
    ...
    private static double turnSpeedRightFoundation3 = 0.6;
    private static boolean frontRightFoundation3 = false;
    private static Path RightFoundation3 = new Path(RightFoundation3Points, toleranceRightFoundation3, KcRightFoundation3, MaxVelocityRightFoundation3, turnSpeedRightFoundation3, frontRightFoundation3);

    //    TODO Parking Points
    private static OurPoint[] ParkingPoints = {
            new OurPoint(-1, 1, 180),
            new OurPoint(-1, 0.5, 180),
            new OurPoint(-1.02 , 0, 180)};
    private static double toleranceParking = 70;
    ...
    public static Path[] CenterPaths = {Center1, CenterFoundation, FoundationBack, Center2, CenterFoundation2, Center3, CenterFoundation3,Parking};
    public static Path[] RightPaths = {Right1, RightFoundation, FoundationBack,  Right2, RightFoundation2, Right3, RightFoundation3, Parking};
