...
public class Paths_Library_Red_Fata_4Cubes {


    private static OurPoint[] Left1Points = {
            new OurPoint(1.566, -0.8325, 140),
            new OurPoint(0.76, -1.37, 140),
    ...
    private static OurPoint[] Left4Points = {
            new OurPoint(1.4, 1.13, 173),
            new OurPoint(1.1, 0.6, 173),
            new OurPoint(1, -0.6, 110),
            new OurPoint(0.87, -1, 110),
            new OurPoint(0.3, -1.3, 110)};
    private static double toleranceLeft4 = 95;
    private static double KcLeft4 = 2.5;
    private static double MaxVelocityLeft4 = 1.5;
    private static double turnSpeedLeft4 = 0.5;
    private static boolean frontLeft4 = true;
    private static Path Left4 = new Path(Left4Points, toleranceLeft4, KcLeft4, MaxVelocityLeft4, turnSpeedLeft4, frontLeft4);

    private static OurPoint[] LeftFoundation4Points = {
            new OurPoint(0.3, -1.3, 110),
            new OurPoint(1, -0.6, 180),
            new OurPoint(1, 0.3, 180),
            new OurPoint(1, 1, 180)};
    private static double toleranceLeftFoundation4 = 100;
    private static double KcLeftFoundation4 = 2.5;
    private static double MaxVelocityLeftFoundation4 = 1.5;
    private static double turnSpeedLeftFoundation4 = 0.6;
    private static boolean frontLeftFoundation4 = false;
    private static Path LeftFoundation4 = new Path(LeftFoundation4Points, toleranceLeftFoundation4, KcLeftFoundation4, MaxVelocityLeftFoundation4, turnSpeedLeftFoundation4, frontLeftFoundation4);


    //    TODO Center Points
    private static OurPoint[] Center1Points = {
            new OurPoint(1.566, -0.8325, 140),
            new OurPoint(0.76, -1.17, 140),
    ...
    private static OurPoint[] Center2Points = {
            ...
            new OurPoint(1.05, 0.6, 185),
            new OurPoint(1, 0, 185),
            new OurPoint(1.1, -0.2, 155),
            new OurPoint(1, -0.55, 155),
            new OurPoint(0.8, -0.59, 155),
            new OurPoint(0.5, -1.1, 155)};
    ...
    private static OurPoint[] Center3Points = {
            new OurPoint(1.05, 1.07, 180),
            new OurPoint(1, 0.6, 180),
            new OurPoint(1, -0.2, 140),
            new OurPoint(0.92, -0.6, 140),
    ...
    public static Path[] LeftPaths = {Left1, LeftFoundation, Left2, LeftFoundation2, Left3, LeftFoundation3, Left4, LeftFoundation4, Parking};
    public static Path[] CenterPaths = {Center1, CenterFoundation, Center2, CenterFoundation2, Center3, CenterFoundation3,Parking};
    public static Path[] RightPaths = {Right1, RightFoundation, Right2, RightFoundation2, Right3, RightFoundation3, Parking};
