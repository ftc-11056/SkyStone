...
public class Paths_Library_Red_3Cubes_Backup {


    private static OurPoint[] Left1Points = {
            new OurPoint(1.566, -0.8325, 140),
            new OurPoint(0.76, -1.39, 140),
    ...
    private static OurPoint[] Center1Points = {
            new OurPoint(1.566, -0.8325, 140),
            new OurPoint(0.76, -1.19, 140),
            new OurPoint(0.53, -1.43, 180)};
    ...
    private static OurPoint[] Right1Points = {
            new OurPoint(1.566, -0.8325, 140),
            new OurPoint(0.76, -0.99, 140),
            new OurPoint(0.53, -1.23, 180)};
