...
public  class VuforiaStone extends basicAuto {
   ...
   // private VuforiaLocalizer vuforia= null ;
    ...
    /*Constructor*/
    public VuforiaStone(WebcamName webcamName, VuforiaLocalizer.Parameters parametersVu, VuforiaTrackables targetsSkyStone, VuforiaLocalizer vuforia,OpenGLMatrix lastLocation){
        this.lastLocation = lastLocation;
        this.vuforia= vuforia;
        this.webcamName=webcamName ;
        this.parametersVu= parametersVu;
        this.targetsSkyStone = this.vuforia.loadTrackablesFromAsset("Skystone");

    }


    public float ConceptVuforiaSkyStoneNavigationWebcam ()
...
*/
        ...
        for (VuforiaTrackable trackable : allTrackables) {
            ...
            runtime.reset();
            while (!isStopRequested() && runtime.seconds() < 2) {
