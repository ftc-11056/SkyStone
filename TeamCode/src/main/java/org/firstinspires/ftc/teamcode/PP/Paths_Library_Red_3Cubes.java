...
public class Paths_Library_Red_3Cubes {
    ...
    private static OurPoint[] Left3Points = {
            new OurPoint(0.95, 1.13, 180),
            new OurPoint(0.95, 0.8, 180),
            new OurPoint(0.95, -0.2, 110),
    ...
    private static OurPoint[] LeftFoundation3Points = {
            new OurPoint(0.35, -0.7, 110),
            new OurPoint(0.95, -0.6, 180),
            new OurPoint(0.95, 0.3, 180),
            new OurPoint(0.95, 1, 180)};
    ...
    private static OurPoint[] Center2Points = {
            ...
            new OurPoint(1.1, 0.6, 185),
            new OurPoint(1.1, 0, 185),
            new OurPoint(1.2, -0.17, 155),
            new OurPoint(1.2, -0.65, 155),
            new OurPoint(0.85, -0.7, 155),
            new OurPoint(0.65, -1.2, 155)};
    ...
    private static OurPoint[] CenterFoundation2Points = {
            new OurPoint(0.65, -1.15, 160),
            new OurPoint(1.1, -0.5, 180),
            new OurPoint(1.1, 0.5, 180),
            new OurPoint(1.1, 0.8, 180),
    ...
    private static OurPoint[] Center3Points = {
            ...
            new OurPoint(1.1, -0.5, 170),
            new OurPoint(0.92, -0.8, 170),
            new OurPoint(0.65, -1.1, 170)};
    ...
    private static OurPoint[] CenterFoundation3Points = {
            new OurPoint(0.65, -1.1, 170),
            new OurPoint(1.1, -0.75, 185),
            new OurPoint(1.1, 0.3, 185),
            new OurPoint(1.1, 1.05, 185)};
    ...
    private static double turnSpeedCenterFoundation3 = 0.8;
    ...
    private static OurPoint[] Right2Points = {
            new OurPoint(1.5666, 1.25, 185),
            new OurPoint(1.1, 0.6, 185),
            new OurPoint(1.1, -0.13, 160),
            new OurPoint(1.1, -0.55 ,160),
            new OurPoint(0.55, -1.1, 160)};
    ...
    private static OurPoint[] Right3Points = {
            new OurPoint(1.1, 1.07, 180),
            new OurPoint(1.1, 0.6, 180),
            new OurPoint(1.1, -0.7, 170),
            new OurPoint(0.8, -1.3, 170)};
    ...
    private static OurPoint[] RightFoundation3Points = {
            new OurPoint(0.8, -1.3, 170),
            new OurPoint(1.1, -0.85, 180),
            new OurPoint(1.1, 0.3, 180),
            new OurPoint(1.1, 1.05, 180)};
