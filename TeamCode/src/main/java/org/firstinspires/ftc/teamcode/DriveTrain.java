...
public class DriveTrain extends Robot {
    ...
    private double getAngle() {
        ...
        telemetry.addData("global", globalAngle);
        telemetry.update();
    ...
    public void NewRotate(int degrees, double power, double timeoutR)
...
//        degrees =  degrees-LastDegrees;
        ...
        if (getAngle() < degrees) {
            while (opModeIsActive() && getAngle() < degrees && runtime.seconds() < timeoutR) {
                LF.setPower(power * ((getAngle() - degrees) * PNumber));
                LB.setPower(power * ((getAngle() - degrees) * PNumber));
                RF.setPower(-power * ((getAngle() - degrees) * PNumber));
                RB.setPower(-power * ((getAngle() - degrees) * PNumber));

                telemetry.addData("get engels", getAngle());
