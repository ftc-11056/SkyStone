 ...
 */
@TeleOp(name = "Skystone Detector PhoneCam", group="DogeCV")

public class skystoneDetectorNew extends LinearOpMode {
...
//        webcamName = hardwareMap.get(WebcamName.class, "Webcam 1");
       ...
       // phoneCam = new OpenCvInternalCamera(OpenCvInternalCamera.CameraDirection.BACK, cameraMonitorViewId);
        phoneCam = new OpenCvWebcam(hardwareMap.get(WebcamName.class, "Webcam 1"));
